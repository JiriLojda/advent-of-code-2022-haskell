...
import Day21.Solution qualified as Day21
import Day22.Solution qualified as Day22
...
callDay str = case str of
  ...
  "21" -> printDay (fmap show Day21.task1) (fmap show Day21.task2)
  "22" -> printDay (fmap show Day22.task1) (fmap show Day22.task2)
